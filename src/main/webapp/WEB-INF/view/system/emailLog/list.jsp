...
<section class="content">
						...
						<div class="row">
                            <div class="col-xs-4">						
                            	<div class="input-group">
	                               	...
	                               	<input type="text" id="sendUserNmLike" class="form-control" placeholder="발신자명 입력" maxlength="30">
	                            </div>
                            </div>
                            <div class="col-xs-4">						
                             	<div class="input-group">
                                	<span class="input-group-addon">수신자명</span>
                                	<input type="text" id="recvUserNmLike" class="form-control" placeholder="수신자명 입력" maxlength="30">
                             	</div>
                            </div>
							<div class="col-xs-4">						
                             	<div class="input-group">
                                	<span class="input-group-addon">수신자 Email</span>
                                	<input type="text" id="recvEmailLike" class="form-control" placeholder="수신자 Email입력" maxlength="30">
                             	</div>
                            </div>
						</div>
					</form>
	...
	<div class="modal fade emailDetail-modal" tabindex="-1" aria-hidden="true">
