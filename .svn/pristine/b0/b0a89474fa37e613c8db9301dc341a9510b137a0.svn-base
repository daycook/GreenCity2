						...
						<div class="row">
							<div class="col-xs-6">						
                            	<div class="input-group">
                               		...
                               		<input type="text" name="userLoginIdLike" id="userLoginIdLike" class="form-control" placeholder="사용자 ID입력" maxlength="50">
                             	</div>
							</div>
							<div class="col-xs-6">						
                             	<div class="input-group">
                                	<span class="input-group-addon">사용자명</span>
                                	<input type="text" name="userNmLike" id="userNmLike" class="form-control" placeholder="사용자명 입력" maxlength="50">
                            	</div>
                            </div>
						</div>
...
<div class="modal fade webLogDtl-modal" tabindex="-1" aria-hidden="true">
		...
		datatable = $("#datatable").DataTable({
			...
			,"columns": [
				...
				{ "render" : 
					function (data, type, row) {
						var html = "";
						html += "<button type='button' class='btn btn-xs btn-info' data-toggle='tooltip' title='상세' onclick='showWebLogDtl(\""+row["user"]["userLoginId"]+"\",\""+row["user"]["userNm"]+"\",\"";
						...
						html += "<button type='button' class='btn btn-xs btn-user' data-toggle='tooltip' title='사용자이력' onclick='showWebUserLog(\""+row["user"]["userId"]+"\")'><i class='fa fa-user'></i></button>&nbsp;";
						html += "<button type='button' class='btn btn-xs btn-list' data-toggle='tooltip' title='세션이력' onclick='showWebLoginLog(\""+row["loginLog"]["loginLogId"]+"\")'><i class='fa fa-list'></i></button>&nbsp;";
